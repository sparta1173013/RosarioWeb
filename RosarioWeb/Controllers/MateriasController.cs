...
namespace RosarioWeb.Controllers
{
    public class MateriasController : Controller
    {
        ...
        public MateriasController(dbRosarioContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Idmateria,Materia1,Año,Semestre")] Materia materia)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Idmateria,Materia1,Año,Semestre")] Materia materia)
        {
